...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="absolute inset-0 bg-black/50">
          <div className="container mx-auto px-4 h-full flex items-center">
            <div className="max-w-2xl text-white">
              <div className="bg-sky-500 text-black px-4 py-1 rounded-full inline-block mb-4 font-semibold">
                {t('publicSchool')}
              </div>
              <h1 className="text-5xl font-bold mb-6">{t('welcome')}</h1>
              <p className="text-xl mb-4">{t('qualityEducation')}</p>
              <p className="text-lg mb-8">{t('description')}</p>
              <button className="bg-sky-500 text-black px-8 py-3 rounded-full font-semibold hover:bg-sky-400 transition flex items-center gap-2">
      ...
      {/* Stats Section */}
      <div className="py-16 bg-sky-500">
        <div className="container mx-auto px-4">
              ...
              <div className="prose max-w-none">
                ...
                <ul className="grid md:grid-cols-2 gap-4 mb-8">
                  <li className="flex items-start gap-2">
                    <Heart className="w-6 h-6 text-sky-500 flex-shrink-0 mt-1" />
                    <div>
                  ...
                  <li className="flex items-start gap-2">
                    <GraduationCap className="w-6 h-6 text-sky-500 flex-shrink-0 mt-1" />
                    <div>
                  ...
                  <li className="flex items-start gap-2">
                    <Users className="w-6 h-6 text-sky-500 flex-shrink-0 mt-1" />
                    <div>
                  ...
                  <li className="flex items-start gap-2">
                    <Sparkles className="w-6 h-6 text-sky-500 flex-shrink-0 mt-1" />
                    <div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
                <a 
                  href="https://maps.app.goo.gl/yJ6bPEpxF7q6tAkX9"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-sky-500 text-black px-8 py-3 rounded-full font-semibold hover:bg-sky-400 transition flex items-center gap-2 justify-center"
                >
